...
public class EnabledDisplayedSelected {
    ...
    public void isElementEnabled() {
       ...
       WebDriver driver = new ChromeDriver();
        ...
        // First to verify - go to ChroPath and type //*[@name='login']
         ...
         * return type: boolean
         */
        boolean isLoginisSelected = loginButton.isSelected();   // exp: true
        Assert.assertTrue(isLoginisSelected, "Login button is not selected");
